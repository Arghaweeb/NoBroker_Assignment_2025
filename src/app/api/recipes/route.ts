...
const RecipeSchema = z.object({
	...
	countryOfOrigin: z.string().describe('The country or cuisine origin of the dish (e.g., "Italy", "China", "Mexico", "India")'),
});
	...
	try {
		...
		const { object } = await generateObject({
			...
			prompt: `Given these ingredients: ${ingredients.join(', ')},
               ...
               - Identify the country or cuisine origin for each dish
               ...
               - Number of servings
               - Country or cuisine of origin (e.g., "Italy", "China", "Mexico", "India", "Thailand", "France", etc.)`,
		});
